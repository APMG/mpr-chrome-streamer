...
(function () {
    var APMPlayerWebtrends = function(){
        ...
        wtSendData = function (vars) {
            ...
            // WT9 uses _tag.dcsMultiTrack() while WT10 uses dcsMultiTrack()
            if (typeof _tag != 'undefined' && typeof _tag.dcsMultiTrack != 'undefined') {
    ...
    // Allow a AMD usage of this as well.
    if (typeof define === "function" && define.amd) {
        define("apmplayer_webtrends", [], function() {
            return APMPlayerWebtrends;
        });
    } else {
        // Call immediately
        APMPlayerWebtrends();
